  ...
  experience: [
    {
      ...
      endDate: null,
      highlights: [
        "[AI Agent 기반 콜봇 시스템 | 2026.03 ~ 진행중] 규칙 기반 가드 + 대화 흐름 제어 + Tool Calling으로 LLM의 자유도를 단계적으로 제약하는 구조 설계 — RTX 3090 단일 GPU, 9B 모델로 5채널 동시 통화 P50 154ms / P99 300ms 미만, 엣지 52/52 PASS, 입력 토큰 47% 감축 — 불완전판매 3중 안전망 + 욕설 이중 감지(키워드+LLM) — 음성 및 대화 엔진 전체 설계·구현 주도 + 팀원 LLM 개발 코칭",
      ],
    },
    {
      company: "(주)사운드마인드",
