...
export const projects: Project[] = [
  {
    ...
    impact: "LLM 호출 85% 절감, GPU 점유율 2.3% | 7노드 상태 머신 + 9개 LLM Tool Calling",
  },
  {
    id: "3",
  ...
  experience: [
    {
      ...
      endDate: null,
      highlights: [
        "[AI Agent 기반 콜봇 시스템 | 2026.02 ~ 진행중] 보험 완전판매 모니터링 자동화를 위한 음성 콜봇 대화 엔진 설계 (아웃바운드) — 7노드 상태 머신 + 9개 LLM Tool Calling 기반 AI Agent 대화 흐름 설계 — 5단계 하이브리드 라우팅으로 단순 의도 LLM 우회, LLM 호출 85% 절감, GPU 점유율 2.3% — 다층 가드레일: off_topic 3단계 에스컬레이션, 명확화·재시도 제한, 불완전판매 징후 실시간 탐지, 욕설 탐지 — 음성 AI 전체 설계·구현 주도 + 팀원 LLM 개발 코칭",
        ...
        "[회의록 분석 플랫폼 - VoiceNote | 2025.02 - 2025.05] Whisper STT + pyannote 화자분리 + LLM 요약 통합 5개 마이크로서비스 설계·구현 — 화자-텍스트 정렬 알고리즘 직접 구현 (겹침 구간 시간 가중치 + 3단계 폴백) — 30초 증분 STT로 Whisper 할루시네이션 해결, OpenVINO NPU 가속 추론",
