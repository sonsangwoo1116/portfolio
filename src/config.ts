...
export const projects: Project[] = [
  {
    ...
    description: "보험 완전판매 모니터링 AI Agent 기반 콜봇 시스템에서 모든 발화를 LLM에 넣으면 GPU 비용과 지연이 감당되지 않는 문제를 해결했습니다. 규칙 기반 가드 + 상태 머신 + Tool Calling으로 LLM의 자유도를 단계적으로 제약하는 구조를 설계해, RTX 3090 단일 GPU에서 9B 모델로 5채널 동시 통화 P50 154ms / P99 300ms 미만, 엣지 테스트 52/52 PASS, 입력 토큰 47% 감축을 달성했습니다.",
    domain: "AI Agent",
    ...
    impact: "엣지 52/52 PASS, P50 154ms, 토큰 47% 감축 | 규칙 기반 가드 + 상태 머신 + LLM Tool Calling 설계",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    impact: "과학기술정보통신부 | 텍스트·음성 멀티모달 우울증 분류 + 감정 기반 칵테일 추천 IoT 시스템",
  },
  {
    id: "12",
  ...
  experience: [
    {
      ...
      endDate: null,
      highlights: [
        "[AI Agent 기반 콜봇 시스템 | 2026.03 ~ 진행중] 규칙 기반 가드 + 상태 머신 + Tool Calling으로 LLM의 자유도를 단계적으로 제약하는 구조 설계 — RTX 3090 단일 GPU, 9B 모델로 5채널 동시 통화 P50 154ms / P99 300ms 미만, 엣지 52/52 PASS, 입력 토큰 47% 감축 — 불완전판매 3중 안전망 + 욕설 이중 감지(키워드+LLM) — 음성 및 대화 엔진 전체 설계·구현 주도 + 팀원 LLM 개발 코칭",
      ],
    },
    {
      company: "(주)사운드마인드",
